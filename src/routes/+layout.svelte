...
<div class="flex relative flex-col max-w-[1400px] mx-auto w-full  sm:text-base min-h-screen">
  <div class={"fixed bottom-0 left-0 w-full duration-200 flex p-10 z-[10] " +
    (y > 0 
